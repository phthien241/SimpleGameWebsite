        ...
        <div className="intro py-20">
          <div className="grid grid-cols-2 gap-4 p-12">
            <div className="my-auto p-4">
              ...
              era. A simple yet endlessly entertaining game, it invites players
              to engage in a captivating paddle-and-ball showdown. Test your
              reflexes and agility as you control your paddle, trying to
              outmaneuver your opponent and score points. Whether you're seeking
              a quick burst of nostalgia or introducing a new generation to its
              charm, Pong remains a delightful journey back to the roots of
              gaming fun.
            </div>
            <img
          ...
          <div className="grid grid-cols-2 gap-4 p-12">
            ...
            ></img>
            <div className="my-auto p-4">
              Flappy Bird is an addictive and deceptively simple mobile game
              that captured the hearts of players worldwide. In this
              minimalistic yet challenging experience, players guide a small
              bird through a maze of pipes by tapping the screen, with each
              successful passage earning a point. The game's relentless
              difficulty and 'one more try' appeal made it an overnight
              sensation, turning simple navigation into a test of precision and
              patience. While it achieved notoriety for its addictive nature,
              Flappy Bird remains a beloved reminder of the endless pursuit of
              high scores in the world of mobile gaming.
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 p-12">
            <div className="my-auto p-4">
          ...
          <div className="grid grid-cols-2 gap-4 p-12">
            ...
            ></img>
            <div className="my-auto p-4">
              A match 3 puzzle game is a popular genre where players match three
              or more identical items in a grid to clear them and achieve
              specific goals, like scoring points or completing levels. They
              feature colorful graphics, animations, and power-ups, offering
              addictive and casual gameplay suitable for all ages.
            </div>
          </div>
        </div>
        <div className="story">
              ...
              <div className="relative">
                ...
                <div className="wrap-story border-2 h-96 w-80 absolute mt-12 p-4 rounded-lg transform -translate-x-1/2 left-1/2 z-[-1]">
                  <p className="mt-12">
                    ...
                    intuitive user interface and visually appealing graphics
                    make the entire gaming experience both enjoyable and
                    addictive. It's a fantastic platform for unwinding after a
                    long day or challenging my skills in a fun and engaging way.
                  </p>
                </div>
              </div>
              <div className="relative">
              ...
              <div className="relative">
                ...
                <div className="wrap-story border-2 h-96 w-80 absolute mt-12 p-4 rounded-lg transform -translate-x-1/2 left-1/2 z-[-1]">
                  <p className="mt-12">
                    ...
                    objectives, ensures there's always something exciting to
                    try. The website's user-friendly layout and attention to
                    detail, such as scoreboards and achievements, enhance the
                    overall enjoyment. I can't recommend it enough to fellow
                    gamers seeking a fantastic destination for mini-gaming
                    adventures.
                  </p>
                </div>
              </div>
